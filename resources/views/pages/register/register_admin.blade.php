...
@section('content')
  ...
  @endif
  <div class="row">
    <form class="form-group" method="post" enctype="multipart/form-data" action="{{route('admin_register_submit')}}">
      @csrf
      <div class="row">
  ...
  <div class="row">
    <p>Already have an account? <a href="{{route('admin_login')}}">Login</a></p>
  </div>
@endsection
